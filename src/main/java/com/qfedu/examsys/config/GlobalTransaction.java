...
public class GlobalTransaction {
    ...
    //restful包下所有service包或者service的子包的任意类的任意方法      //第一个* 任意返回值                            任意类 任意方法
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.qfedu.examsys.service.impl.*.*(..))";

    @Autowired
    private PlatformTransactionManager transactionManager;

    @Bean//创建对象 相当于<bean id="txAdvice" class="xxxxxxx.xxxx.TransactionInterceptor"> id 来自于方法名
